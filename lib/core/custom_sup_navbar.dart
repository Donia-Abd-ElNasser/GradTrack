...
class CustomSupBottomNav extends StatelessWidget {
  const CustomSupBottomNav({super.key});
        ...
        child: ClipRRect(
          ...
          child: Builder(
            builder: (context) {
              ...
              int selectedIndex = 0;
              if (location.startsWith(AppRoutes.kGroupView)) {
                selectedIndex = 1;
              }
              if (location.startsWith(AppRoutes.kSupChatView)) {
                selectedIndex = 2;
              }

              if (location.startsWith(AppRoutes.kSupProfileView)) {
                selectedIndex = 3;
              }
              ...
              return BottomNavigationBar(
                ...
                onTap: (index) {
                  switch (index) {
                    case 0:
                      (context).go(AppRoutes.kSupHomeView);
                      break;
                    case 1:
                      (context).go(AppRoutes.kGroupView);
                      break;
                    case 2:
                      (context).go(AppRoutes.kSupChatView);
                      break;

                    case 3:
                      (context).go(AppRoutes.kSupProfileView);
                      break;
                  }
                },
